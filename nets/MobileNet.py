...
def MobileNet(image,
    ...
    with tf.variable_scope('mobile_small'):
        net = slim.convolution2d(image,
                                 32,
                                 scope='conv0',
                                 kernel_size=[3, 3],
                                 trainable=is_training,
                                 reuse=val)
        std0 = slim.batch_norm(net,
                               scope='bn0',
                               trainable=is_training,
                               reuse=val)
        std0 = _depthwise_separable_conv(std0,
                                         64,
                                         1,
        ...
        std1 = _depthwise_separable_conv(std0,
                                         128,
                                         2,
                                         is_training=is_training,
                                         val=val,
        ...
        std2 = _depthwise_separable_conv(std1,
                                         256,
                                         2,
                                         is_training=is_training,
                                         val=val,
        ...
        std3 = _depthwise_separable_conv(std2,
                                         512,
                                         2,
                                         is_training=is_training,
                                         val=val,
    ...
    if is_training:
        with tf.variable_scope('mobile'):
            net = slim.convolution2d(image,
                                     ...
                                     trainable=False,
                                     reuse=val)
            teach0 = slim.batch_norm(net,
                                     scope='bn0',
                                     trainable=False,
                                     reuse=val)
            teach0 = _depthwise_separable_conv(teach0,
                                               64,
                                               1,
                                               is_training=False,
                                               val=val,
            ...
            teach1 = _depthwise_separable_conv(teach0,
                                               128,
                                               2,
                                               is_training=False,
                                               val=val,
                                               name='mobile1')
            teach1 = _depthwise_separable_conv(teach1,
                                               128,
                                               1,
                                               is_training=False,
                                               val=val,
            ...
            teach2 = _depthwise_separable_conv(teach1,
                                               256,
                                               2,
                                               is_training=False,
                                               val=val,
                                               name='mobile3')
            teach2 = _depthwise_separable_conv(teach2,
                                               256,
                                               1,
                                               is_training=False,
                                               val=val,
            ...
            teach3 = _depthwise_separable_conv(teach2,
                                               512,
                                               2,
                                               is_training=False,
                                               val=val,
                                               name='mobile5')
            teach3 = _depthwise_separable_conv(teach3,
                                               512,
                                               1,
                                               is_training=False,
                                               val=val,
