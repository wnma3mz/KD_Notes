...
with tf.Graph().as_default():
    ...
    batch_queue = slim.prefetch_queue.prefetch_queue(
        [batch_images, batch_labels], capacity=dataset.num_samples)
    ...
    sv = supervisor.Supervisor(logdir=checkpoint_path,
                               init_fn=_get_init_fn(checkpoint_path,
    ...
    with sv.managed_session(master='',
        ...
        name = [
            ...
            'conv4w', 'conv4b', 'conv5w', 'conv5b', 'conv6w', 'conv6b',
            'conv7w', 'conv7b', 'conv8w', 'conv8b', 'conv9w', 'conv9b',
            'conv10w', 'conv10b', 'fc1w', 'fc1b', 'fc2w', 'fc2b', 'fc3w',
            'fc3b'
        ]
