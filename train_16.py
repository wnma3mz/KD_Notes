...
dataset_dir = './datasets/cifar-100-python-32'
# dataset_dir = './datasets/cifar-100-python-8'
...
with tf.Graph().as_default() as graph:
    ...
    with tf.variable_scope('clipa_grad1'):
    ...
    summary_op = tf.summary.merge(list(summaries), name='summarya_op')
