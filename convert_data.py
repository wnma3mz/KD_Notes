...
def main(_):
    ...
    if FLAGS.dataset_name == 'CUB':
        convert_CUB.run(FLAGS.dataset_dir)
    ...
    elif FLAGS.dataset_name == 'imgnet32':
        convert_imgnet32.run(FLAGS.dataset_dir)
    elif FLAGS.dataset_name == 'vot':
        convert_vot.run(FLAGS.dataset_dir)
